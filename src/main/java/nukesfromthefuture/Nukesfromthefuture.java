...
import nukesfromthefuture.blocks.Agriessor;
import nukesfromthefuture.blocks.AniNuke;
import nukesfromthefuture.blocks.Antitime;
import nukesfromthefuture.blocks.BigBoy;
import nukesfromthefuture.blocks.BlockSingularityNuke;
import nukesfromthefuture.blocks.BlockTrololo;
import nukesfromthefuture.blocks.BlockUnrefinary;
import nukesfromthefuture.blocks.Blockego_nuke;
import nukesfromthefuture.blocks.Blockego_ore;
import nukesfromthefuture.blocks.ClickBob;
import nukesfromthefuture.blocks.CoordTrans;
import nukesfromthefuture.blocks.Copperore;
import nukesfromthefuture.blocks.CraterCoverer;
import nukesfromthefuture.blocks.CursePort;
import nukesfromthefuture.blocks.Deathinum;
import nukesfromthefuture.blocks.EgoBlock;
import nukesfromthefuture.blocks.EgoFurnace;
import nukesfromthefuture.blocks.Lightning;
import nukesfromthefuture.blocks.Liquifier;
import nukesfromthefuture.blocks.Mars;
import nukesfromthefuture.blocks.POTATOBLOCK;
import nukesfromthefuture.blocks.POTATONook;
import nukesfromthefuture.blocks.PlutoniumOre;
import nukesfromthefuture.blocks.RadioactiveCake;
import nukesfromthefuture.blocks.Reactor;
import nukesfromthefuture.blocks.SkinnyMan;
import nukesfromthefuture.blocks.Solidifier;
import nukesfromthefuture.blocks.SuperEE;
import nukesfromthefuture.blocks.Testblok;
import nukesfromthefuture.blocks.TheBeta;
import nukesfromthefuture.blocks.TheFlood;
import nukesfromthefuture.blocks.Timefissurelog;
import nukesfromthefuture.blocks.Transmutator;
import nukesfromthefuture.blocks.Trol;
import nukesfromthefuture.blocks.TutBlock;
import nukesfromthefuture.blocks.UwU;
import nukesfromthefuture.blocks.Waste;
