...
public class GenLayers extends GenLayer{
	  private List<BiomeEntry> desertBiomes = new ArrayList<BiomeEntry>();
	    ...
	    public GenLayers(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
	    {
	        super(p_i2122_1_);
	        ...
	        if (p_i2122_4_ == WorldType.DEFAULT_1_1)
	        {
	            ...
	            desertBiomes.add(new BiomeEntry(BiomeRegistry.cursedBiome, 10));
	        }
	        else
	        {
