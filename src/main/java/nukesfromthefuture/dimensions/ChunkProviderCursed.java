...
public class ChunkProviderCursed implements IChunkProvider{
	List<EntityLiving> uhhhh_idk = new ArrayList();
	World world;
	...
	public ChunkProviderCursed(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
    ...
    {
		byte b0 = 63;
        this.biomesForGeneration = this.world.getWorldChunkManager().getBiomesForGeneration(this.biomesForGeneration, p_147419_1_ * 4 - 2, p_147419_2_ * 4 - 2, 10, 10);
        this.func_147423_a(p_147419_1_ * 4, 0, p_147419_2_ * 4);
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_147419_3_[j3 += short1] = Blocks.bedrock;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
                                    p_147419_3_[j3 += short1] = Blocks.bedrock;
	...
	private void func_147423_a(int i, int j, int k) {
		// TODO Auto-generated method stub
	        ...
	        double d2 = 512.0D;
	        double d3 = 512.0D;
	        this.field_147426_g = this.noiseGen6.generateNoiseOctaves((double[]) this.field_147426_g, i, j, 5, 5, 200.0D, 200.0D, 0.5D);
	        this.field_147427_d = this.field_147429_l.generateNoiseOctaves(this.field_147427_d, i, j, k, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
	        this.field_147428_e = this.field_147431_j.generateNoiseOctaves(this.field_147428_e, i, j, k, 5, 33, 5, 684.412D, 684.412D, 684.412D);
	        this.field_147425_f = this.field_147432_k.generateNoiseOctaves(this.field_147425_f, i, j, k, 5, 33, 5, 684.412D, 684.412D, 684.412D);
	        boolean flag1 = false;
	        boolean flag = false;
	        int l = 0;
	        int i1 = 0;
