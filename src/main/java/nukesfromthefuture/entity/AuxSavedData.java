...
public class AuxSavedData extends WorldSavedData {
    ...
    public static AuxSavedData getData(World worldObj) {
        ...
        AuxSavedData data = (AuxSavedData)worldObj.perWorldStorage.loadData(AuxSavedData.class, "nffauxdata");
        if(data == null) {
            worldObj.perWorldStorage.setData("nffauxdata", new AuxSavedData());

            data = (AuxSavedData)worldObj.perWorldStorage.loadData(AuxSavedData.class, "nffauxdata");
        }
