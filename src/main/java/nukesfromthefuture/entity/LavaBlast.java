...
public class LavaBlast extends Entity{
	public Supervolcano hoool = null;
	public double		radius;
	public int			time		= 0;
	
	public LavaBlast(World par1World)
	{
		super(par1World);
		ignoreFrustumCheck = true;
	}
	
	public LavaBlast(World par1World, float x, float y, float z, Supervolcano hool, int rad)
	{
		super(par1World);
		ignoreFrustumCheck = true;
		hoool = hool;
		radius = rad;
		motionX = Math.sqrt(radius - Nukesfromthefuture.Volcano_strength) / 10;
		setPosition(x, y, z);
	}
	
	public LavaBlast(World par1World, double x, double y, double z, float rad)
	{
		super(par1World);
		ignoreFrustumCheck = true;
		radius = rad;
		motionX = Math.sqrt(rad - Nukesfromthefuture.Volcano_strength) / 10;
		setPosition(x, y, z);
	}
