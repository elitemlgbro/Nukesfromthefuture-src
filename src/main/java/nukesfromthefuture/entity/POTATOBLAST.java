...
public class POTATOBLAST extends Entity{
	public POTATOEXPLOSION	hoool = null;
	public double		radius;
	public int			time		= 0;
	
	public POTATOBLAST(World par1World)
	{
		super(par1World);
		ignoreFrustumCheck = true;
	}
	
	public POTATOBLAST(World par1World, float x, float y, float z, POTATOEXPLOSION hool, int rad)
	{
		super(par1World);
		ignoreFrustumCheck = true;
		hoool = hool;
		radius = rad;
		motionX = Math.sqrt(radius - Nukesfromthefuture.POTATOSTRENGTH) / 10;
		setPosition(x, y, z);
	}
	
	public POTATOBLAST(World par1World, double x, double y, double z, float rad)
	{
		super(par1World);
		ignoreFrustumCheck = true;
		radius = rad;
		motionX = Math.sqrt(rad - Nukesfromthefuture.POTATOSTRENGTH) / 10;
		setPosition(x, y, z);
	}
