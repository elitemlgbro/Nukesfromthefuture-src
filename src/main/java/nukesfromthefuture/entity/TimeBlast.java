...
public class TimeBlast extends Entity{
	public AntiExplosion	hoool = null;
	public double		radius;
	public int			time		= 0;
	
	public TimeBlast(World par1World)
	{
		super(par1World);
		ignoreFrustumCheck = true;
	}
	
	public TimeBlast(World par1World, float x, float y, float z, AntiExplosion hool, int rad)
	{
		super(par1World);
		ignoreFrustumCheck = true;
		hoool = hool;
		radius = rad;
		motionX = Math.sqrt(radius - Nukesfromthefuture.antitimebuff) / 10;
		setPosition(x, y, z);
	}
	
	public TimeBlast(World par1World, double x, double y, double z, float rad)
	{
		super(par1World);
		ignoreFrustumCheck = true;
		radius = rad;
		motionX = Math.sqrt(rad - Nukesfromthefuture.antitimebuff) / 10;
		setPosition(x, y, z);
	}
