...
public class UwUEx extends Entity {

	public AgriExplosion hoool = null;
	public double		radius;
	public int			time		= 0;
	
	public UwUEx(World par1World)
	{
		super(par1World);
		ignoreFrustumCheck = true;
	}
	
	public UwUEx(World par1World, float x, float y, float z, AgriExplosion hool, int rad)
	{
		super(par1World);
		ignoreFrustumCheck = true;
		hoool = hool;
	...
	public UwUEx(World par1World, double x, double y, double z, float rad)
	{
		super(par1World);
		ignoreFrustumCheck = true;
		radius = rad;
