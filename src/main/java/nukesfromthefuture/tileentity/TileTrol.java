...
public class TileTrol extends TileEntity implements ISidedInventory, IFluidContainer, IFluidAcceptor, IFluidSource{
	...
	public TileTrol() {
		...
		tank = new FluidTank(FluidType.TROL_FLUID, 96000, 0);
	}
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "container.TrolNuke";
	}
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote)
		{
			...
			if((age == 9 || age == 19) && isReady())
				fillFluidInit(tank.getTankType());
			tank.loadTank(3, 2, slots);
	...
	public void setType(FluidType type, int index) {
		tank.setTankType(type.TROL_FLUID);
	}
	...
	public boolean isReady() {
		if(slots[0] != null && slots[1] != null && slots[0].getItem() == Nukesfromthefuture.poorly_drawn_fuse && slots[1].getItem() == Nukesfromthefuture.lighter && tank.getFill() >= 70000) return true;
		return false;
