...
public class TileVolcano extends TileEntity implements ISidedInventory, IFluidContainer, IFluidAcceptor, IFluidSource{
private ItemStack slots[];
	...
	public TileVolcano() {
		...
		tank = new FluidTank(FluidType.LAVA, 256000, 0);
	}
	...
	public boolean isReady() {
		if(slots[0] != null &&
				slots[0].getItem() == Nukesfromthefuture.mentos_fo_lava &&
				tank.getFill() >= 100) return true;
		return false;
