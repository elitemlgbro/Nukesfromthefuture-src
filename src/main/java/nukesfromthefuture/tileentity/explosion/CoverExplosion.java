...
public class CoverExplosion {
	...
	public CoverExplosion(int x, int y, int z, World world, int rad, float coefficient, int i)
	{
		posX = x;
		posY = y;
		posZ = z;
	...
	public boolean update(CoverBlast owo)
	{
		...
		if (n > 0 && n < nlimit)
		{
			...
			{
				repeatCount++;
				if (repeatCount < Nukesfromthefuture.coverSpeed * 2) update(owo);
				else
				{
					repeatCount = 0;
					return true;
